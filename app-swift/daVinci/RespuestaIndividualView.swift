...
struct RespuestaIndividualView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                ForEach(respuesta.solucion.pregunta.alternativas, id: \.id) { alternativa in
                    HStack {
                        Image(systemName: "circle.fill")
                            .foregroundColor(getAlternativaColor(alternativa: alternativa))
                    ...
                    .padding()
                    .background(alternativa.id == respuesta.alternativa_enviada.id ? Color.blue.opacity(0.1) : Color.clear)
                    .cornerRadius(8)
                    .padding(.horizontal)
                }
    ...
    private func getAlternativaColor(alternativa: Alternativa) -> Color {
        ...
        if alternativa.id == respuesta.alternativa_enviada.id && !respuesta.es_correcta {
            return .red
        }
        return .gray
    }
